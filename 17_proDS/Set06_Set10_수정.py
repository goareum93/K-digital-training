...
dataset6=pd.read_csv('Dataset_06.csv')
dataset6.columns
...
dataset7=pd.read_csv("Dataset_07.csv")
...
q3=pd.DataFrame({'var':x.columns.values,
...
dataset8=pd.read_csv('Dataset_08.csv')
...
dataset10=pd.read_csv('Dataset_10.csv')
...
# Ttest_indResult(statistic=1.1025375913936746, 
#                 pvalue=0.27047828249848516)
