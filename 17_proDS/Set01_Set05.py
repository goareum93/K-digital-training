...
['Age', 'Sex', 'BP', 'Cholesterol', 'Na_to_K', 'Age_gr', 
 'Drug']
...
Q2_temp = []
for i in ['Age', 'Sex', 'BP', 'Cholesterol', 'Na_to_K', 'Age_gr']:                      
...
Q4_1 = dataset4[dataset4.LOCATION == 'KOR']

q1_out = pd.pivot_table(data=Q4_1, index='TIME',
                        values='Value',
                        aggfunc='sum')
...
q4_2 = dataset4[dataset4.LOCATION.isin(['KOR', 'JPN'])]
len(dataset4) # 6718
len(q4_2) # 294

q4_2_out = pd.pivot_table(data=q4_2, index=['TIME','SUBJECT'],
                          columns=['LOCATION'], 
                          values='Value')


q4_2_out=q4_2_out.dropna()
q4_2_out=q4_2_out.reset_index()

sub_list = q4_2_out.SUBJECT.unique()
...
for i in sub_list:
    temp = q4_2_out[q4_2_out.SUBJECT==i]
    pvalue = ttest_rel(temp['KOR'], temp['JPN']).pvalue
    q4_2_out2 = q4_2_out2 + [[i, pvalue]]
    
q4_2_out2 = pd.DataFrame(q4_2_out2, columns=['sub','pvalue'])

q4_2_out2[q4_2_out2.pvalue >= 0.05]
# 정답 : POULTRY
